...
public class KeyboardHook : IDisposable
{
        ...
        int nCode, IntPtr wParam, ref KBDLLHOOKSTRUCT lParam)
    {
        ...
        {*/
            ...
            OnKeyIntercepted(new KeyboardHookEventArgs(lParam.vkCode, AllowKey, nCode >= 0 && (wParam == (IntPtr)WM_KEYUP || wParam == (IntPtr)WM_SYSKEYUP)));

            //If this key is allowd, pass on to next app
            if (AllowKey)
            {
    ...
    public class KeyboardHookEventArgs : System.EventArgs
    {
        ...
        public KeyboardHookEventArgs(int evtKeyCode, bool evtPassThrough, bool keyUp)
        {
            keyName = ((Keys)evtKeyCode).ToString();
            keyCode = (Keys)evtKeyCode;
